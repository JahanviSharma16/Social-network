...
const Profile = () => {
    ...
    return (
        <>
            <MetaData title={`${user?.name} (@${user?.username}) • Connectify photos and videos`} />
                    ...
                    <div className="border-t sm:ml-8 sm:mr-14">
                        ...
                        {savedTab ?
                            ...
                            user?.posts?.length > 0 ?
                                ...
                                {/* <font size="20"><b><i>Connectify</i></b></font> */}
                                    <img draggable="false" className="w-2/5 rounded-l" src="" alt="" />
